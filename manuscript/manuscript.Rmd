...
WK performed the analyses and wrote the manuscript. BH helped design the metrics and implement the regressions as well as providing support and context for the analysis. AI provided funding and support and helped interpret the conclusions.
...
![Supplemental figure 4: Performance of regularized regression and random forest models on internally (same train-test) and externally (different train-test) validated datasets.](supplement/regregrf_fdrgff_cross_train.png){width=90%}
...
bind_rows(fdr_gff_individual, fdr_gff_full_model, fdr_gff_stricter_thresh) %>%
  write_csv("manuscript/supplement/supp_table_2_model_confusion_matrices.csv")
```
